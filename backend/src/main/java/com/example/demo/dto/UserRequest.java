...
public class UserRequest {
   ...
   */
  public UserRequest(String username, String password, String status) {
  ...
  */
  ...
  @Schema(name = "displayName", example = "ユーザー1", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "status", example = "enable", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("status")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, username, displayName, password, status);
  }
